...
{
    public class CreateCustomerCommandExamples : IMultipleExamplesProvider<CreateCustomerCommand>
    {
        public IEnumerable<SwaggerExample<CreateCustomerCommand>> GetExamples()
        {
            yield return SwaggerExample.Create("Giorgi", new CreateCustomerCommand
            {
                FirstName = "Giorgi",
                LastName = "Giorgadze",
            ...
            yield return SwaggerExample.Create("Nino", new CreateCustomerCommand
            {
                FirstName = "Nino",
                LastName = "Ninoshvili",
